...
class ProjectGetByOrganizationTest extends TestCase
{
    public function testGetProjectsByOrganizationSuccess()
    {
        ...
        $response = $this->actingAs($user)->getJson("api/projects/find_by_organization/$organization->id");
    ...
    public function testGetProjectByOrganizationNotFound()
    {
        ...
        $response = $this->actingAs($user)->getJson("api/projects/find_by_organization/$notExistOrganizationId");
    ...
    public function testGetProjectByOrganizationFromAnotherCompanySupervisorOrEmployeeForbidden()
    {
        ...
        $response = $this->actingAs($users[0])->getJson("api/projects/find_by_organization/{$organizations[1]->id}");
    ...
    public function testGetProjectByOrganizationUnauthorized()
    {
        ...
        $response = $this->getJson("api/projects/find_by_organization/$organization->id");
